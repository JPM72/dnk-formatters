...
export const contractWhitespace = (s) => _.trim(_.replace(s, /\s+/g, ' '));
...
export const leadingZeros = (str, length) => _.padStart(str, length, '0');
export const trailingZeros = (str, length) => _.padEnd(str, length, '0');
